...
export const legacyLisbonSnapshot = defineLegacyLisbonSnapshot({
  ...
  rules: [
    ...
    },
    {
      ...
      requires: [],
      timeWindow: null,
      result: 'churchAfterEnricoAfterGift',
    },
    {
      building: '1',
      blockedBy: ['houseBeforeQuest'],
  ...
  operations: [
    {
      key: 'houseBeforeQuest',
      callback: 'messages[38].action',
      operations: ['recruitRocco'],
    },
    {
      key: 'houseAfterQuestAndPub',
      callback: 'messages[13].action',
      operations: ['buyItem(53, true)'],
    },
    {
      key: 'pubAfterQuest',
      callback: 'messages[13].action',
      operations: ['receiveGold(1000)'],
    },
    {
      key: 'lodgeBankGuildBeforeQuestRandom1',
      callback: 'messages[1].action',
      operations: ['exitBuildingIfNotLodge'],
    },
    {
      key: 'lodgeBankGuildBeforeQuestRandom2',
      callback: 'messages[1].action',
      operations: ['exitBuildingIfNotLodge'],
    },
    {
      key: 'lodgeBankGuildBeforeQuestRandom3',
      callback: 'messages[1].action',
      operations: ['exitBuildingIfNotLodge'],
    },
    {
      key: 'itemShopAfterQuest',
      callback: 'messages[3].action',
      operations: ['buyItem(4, true)'],
    },
    {
      key: 'shipyardAfterQuest',
      callback: 'messages[3].action',
      operations: ['receiveFirstShip'],
    },
    {
      key: 'churchAfterQuest',
      callback: 'messages[20].action',
      operations: ['recruitEnrico'],
    },
    {
      key: 'churchAfterEnrico',
      callback: 'messages[1].action',
      operations: ['receiveGold(1000)'],
    },
    {
    ...
    {
      key: 'harborFinal',
      callback: 'messages[16].confirm.no',
