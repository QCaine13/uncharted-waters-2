# Story Outline (Original 6 routes)

**Status**: Reference · **Date**: 2026-06-13 · Layer: baseline (the new 剧本 in
`../3-narrative/` layers on top of this — see [DECISIONS.md](../DECISIONS.md) D1)
