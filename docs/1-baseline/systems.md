...
> **Update (2026-06-13)**: Trade (market) and Save/Load — called out below as the
> most valuable next systems — have since shipped as MVPs (commit `9593a11`). The
> live next priorities are now: (1) **version migration** for saves, (2) the
> **data-driven quest engine** (4-engineering), and (3) a **localization layer**
> before more hard-coded English spreads.

The most valuable next systems were trade and save/load. Trade gives the player
