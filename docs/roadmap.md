...
首批 M0 已通过功能验收及独立任务审查：默认简体中文、英文切换、现有界面与开场汉化、海上读档及音频中断修复均已实现。最终54套/462项单元测试通过；完整浏览器基线15套/63项通过，随后音频修复的中文真实旅程单独通过。全分支审查进行中，具体版本与验证方法见[验收记录](superpowers/verification/2026-09-06-chinese-foundation.md)。
