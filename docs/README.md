...
| 名声（冒险/海盗/贸易）                         | 🔶 冒险名声已激活                        | 发现地标授予冒险名声（[D12](DECISIONS.md)）；海盗 / 贸易名声仍无来源，UI 显示待 C2                                                                                                                                          |
| **探索发现**                                   | ✅ MVP 已实现                            | 14 条史实地标，坐标由真实经纬度经投影推导；Save v4 记录已发现项。见 [D12](DECISIONS.md) 与 [设计](superpowers/specs/2026-08-14-discovery-mvp-design.md)                                                                     |
