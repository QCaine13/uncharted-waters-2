...
- [x] Produce a whole-branch review package and resolve important findings. Deliver the local preview and paths to the plan/review without claiming later milestones complete.
